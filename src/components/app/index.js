...
export default class App extends React.Component {
  ...
  componentDidMount() {
    PIXI.loader
      ...
      .add("assets/library-pillar-1.png")
      .add("assets/librarian-frame-1.png")
      .add("assets/librarian-frame-2.png")
      .add("assets/panel-1.png")
      .add("assets/skyline-1.png")
      .add("assets/theater-leg.png")
      .add("assets/star-1.png")
      .add("assets/school-1.png")
      .add("assets/kite-frame-1.png")
