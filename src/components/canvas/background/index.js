  ...
  constructor() {
    ...
    this.state = {
      ...
      trees: [
        ...
        { type: "TREE_STATIC", position: [0.87, 0], size: 0.35, speed: 0.85, opacity: 1, image: 0 },
        { type: "TREE_STATIC", position: [0.92, 0], size: 0.3, speed: 0.85, opacity: 1, image: 0 },
        ...
        { type: "TREE_STATIC", position: [1.75, 0], size: 0.4625, speed: 0.85, opacity: 1, image: 0 },
