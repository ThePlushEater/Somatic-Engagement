  ...
  render() {
    ...
    if (parent) {
      ...
      if (!this.object) {
        let frame;
        switch(item.image) {
          case 0: { frame = "assets/mountain-1.png"; break; }
          case 1: { frame = "assets/mountain-2.png"; break; }
          case 2: { frame = "assets/mountain-3.png"; break; }
          case 3: { frame = "assets/mountain-4.png"; break; }
          case 4: { frame = "assets/mountain-5.png"; break; }
          case 5: { frame = "assets/mountain-6.png"; break; }
        }
