    ...
    return(
      <div className="header">
        <div id="nav-item-1" className="title" onClick={this.handleClickNavItem.bind(this, "HOME")}>
          <span>S</span><img className="logo off" src="./logo.png" /><span>MA</span>
        </div>
        <ul className="nav-group">
          <li id="nav-item-2" className={"item" + navItemsActive[0]} onClick={this.handleClickNavItem.bind(this, "HOME")}>ABOUT</li>
          <li id="nav-item-3" className={"item" + navItemsActive[1]} onClick={this.handleClickNavItem.bind(this, "RESEARCH")}>RESEARCH</li>
          <li id="nav-item-4" className={"item" + navItemsActive[2]} onClick={this.handleClickNavItem.bind(this, "PROJECTS")}>PROJECTS</li>
          <li id="nav-item-5" className={"item" + navItemsActive[3]} onClick={this.handleClickNavItem.bind(this, "CONTACT")}>CONTACT</li>
        </ul>
      </div>
    );
  }
